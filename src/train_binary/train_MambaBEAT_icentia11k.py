...
def main() -> None:
    ...
    # pretrained_path = "/work/home/js54mumy/Mamba/src/benchmarks/binary_MambaBEAT.pth"
    pretrained_path = r"C:\wenjian\MasterArbeit\Code\repo\test_repo\src\benchmarks\binary_MambaBEAT_1k.pth"
